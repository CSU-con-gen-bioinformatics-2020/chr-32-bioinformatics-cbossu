...
rclone copy --tpslimit 10 --fast-list -P --drive-shared-with-me Gdrive-CSU:CSU-con-gen-2020/pre-indexed-chinook-genome  genome
...
rclone copy --tpslimit 10 --fast-list -P --drive-shared-with-me Gdrive-CSU:CSU-con-gen-2020/fastqs-chr32-160-chinook-8-lanes  fastqs-chr32-160-chinook-8-lanes
...
ln -s /home/cbossu@colostate.edu/scratch/chinook-play/CSU-con-gen-2020/chr-32-bioinformatics-cbossu/genome genome
...
# Here is what I did (making a symbolic link)
ln -s  /home/cbossu@colostate.edu/scratch/chinook-play/CSU-con-gen-2020/chr-32-bioinformatics-cbossu/fastqs-chr32-160-chinook-8-lanes fastqs
